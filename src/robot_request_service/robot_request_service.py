...
class RobotRequest_impl():
    def __init__(self,parameter_file,robot_url):
        ...
        self.vertices = [
                    ...
                    {'name': 'CL_0',    'pos': [1911.1,-500.0,1195.27],     'quat': [0.707106781,0.0,0.707106781,0.0],  'conf': (-1,-1,0,1)     }, 
                    ...
                    {'name': 'CU_0',    'pos': [1911.1,-500.0,1500.07],     'quat': [0.707106781,0.0,0.707106781,0.0],  'conf': (-1,-1,0,1)      },
        ...
        self.edges = [   
                    ...
                    {'source': 'UNC_4',     'target': 'UNC_5',  'motion': 'MoveL',      'speed': self.v_gnrl, 'wait': '0.5'},
                    {'source': 'UNC_5',     'target': 'UNC_0',  'motion': 'MoveL',      'speed': self.v_gnrl, 'wait': '0.5'},
