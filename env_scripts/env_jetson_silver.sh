...
sleep 6s #let kinect to start
gnome-terminal --display=:0 --command "bash -c \"source ~/.bashrc; python ~/catkin_ws_kinect/src/safe_energetics_services/src/level_sensor_service/level_sensor_service.py; exec bash\""
exec "$@"